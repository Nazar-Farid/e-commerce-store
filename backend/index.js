...
const mongoUrl = 'mongodb+srv://nazarfarid1122:nazarfarid1122.@cluster0.vnar5kp.mongodb.net/?retryWrites=true';

// Check if the MONGO_URL environment variable is defined
if (!mongoUrl) {
  console.error('Error: MONGO_URL is not defined in config.env');
